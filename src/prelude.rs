...
The [`base`] module (`use bitvec::prelude::base::*;`) imports only the data
types and macros needed to make direct use of the crate. It also imports trait
*methods* from [`BitField`] and [`BitView`], without importing those trait
names.
